    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                <td style="text-align:center;">
                    <?php echo ($val['system_id']); ?>
                </td>
                <td style="text-align:center;">
                    <?php echo ($val['card_no']); ?>
                </td>
                <td style="text-align:center;">
                    <?php echo ($val['discount']); ?>折
                </td>
                <td style="text-align:center;">
                ...
                <td style="text-align:center;">
                    ...
                    <button style="background: #2c3e50;border:2px; width: 70px; height: 40px;"  value="<?php echo $val['id']; ?>" class="chongzhi"><span style="color: white; font-size: 8px;">充值</span></button>
