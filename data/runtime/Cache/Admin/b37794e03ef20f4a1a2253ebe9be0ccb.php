...
<body>
	<div class="wrap js-check-wrap">
		...
		<form class="well form-search" method="post" action="<?php echo U('Admin/Deliver/C_deliverList'); ?>">
			...
			<!--</select> &nbsp;&nbsp;-->
			关键字： 
			<input type="text" name="keyword"  style="height:34px; width: 200px;" value="<?php echo ($keyword); ?>" placeholder="请输入查询的订单ID或卡号">
					...
					<?php foreach ($data as $k => $v) { ?>
						<tr>
							...
							<td style="text-align:center;">
								...
								<!--<?php echo '<font style="color:red">￥</font>'.$v['real_pay']; ?>-->
							</td>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block;padding-left: 0px;margin-left:500px;height:340px;width: 50%;">
	...
	<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block;padding-left: 0px;margin-left:500px;height:340px;width: 50%;">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
				<!--&times;-->
			</button>
