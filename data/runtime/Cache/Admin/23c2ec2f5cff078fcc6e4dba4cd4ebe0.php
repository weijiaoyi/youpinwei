...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('gradelist'); ?>">VIP会员列表</a></li>
        <!--<li><a href="<?php echo U('add_grade'); ?>">添加代理商</a></li>-->
    </ul>
        <!-- 搜索 start by LEE  -->
        <form class="well form-search" method="post" action="<?php echo U('Admin/Grade/viplist'); ?>">
            当前用户状态：
    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="text-align:center;">
                <?php if($val['is_notmal'] == '1'): ?><span style="font-size: 14px;color: #00FF00;font-weight: bold;">正常</span>
            ...
            <td style="text-align:center;">
                <button style="background: #2c3e50;border:0px; width: 70px; height: 40px;" ><a href="<?php echo U('getOffline',['id'=>$val['id']]);?>"><span style="color: white; font-size: 8px;">查看下线</span></a></button>
