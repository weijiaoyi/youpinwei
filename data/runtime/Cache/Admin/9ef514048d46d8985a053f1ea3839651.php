				...
				<?php foreach ($data as $k => $v) { ?>
					<tr>
						...
						<td style="text-align:center;">
							<?php echo empty($v['nickname'])?'未绑定':'<img src="'.$v['user_img'].'" width="35" hight="35">'.'&nbsp;&nbsp;'.$v['nickname']; ?>
						</td>
						...
						<td style="width:300px; height: 53px; text-align:center;">
							...
							<?php }?>
							<button id="order-info" style="background: #2c3e50;border:2px; width: 70px; height: 40px;color: white" class="edpro">消费记录</button>
...
<div class="modal-dialog">
	<!-- <div class="modal-content"> -->
	<div class="modal fade" id="myModalInfoList" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block;padding-right: 0px;margin-left:500px;height:340px;">
...
<script>
	...
	$(document).on('click','#order-info',function(){
		...
		$.ajax({
			...
			dataType:"json",
			// contentType:"jsonp",
			url:hostUrl+"/index.php?g=admin&m=order&a=getCard",//提交URL
			// url:"http://ypw.com/index.php?g=Admin&m=Order&a=cardOrder",//提交URL
