...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('gradelist'); ?>">代理商列表</a></li>
    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td style="text-align:center;">
                    ...
                    <button style="background: #2c3e50;border:2px; width: 110px; height: 40px;" ><a href="<?php echo U('getMyCard',['this_id'=>$val['id']]);?>"><span style="color: white; font-size: 8px;">查看我的油卡</span></a></button>
                </td>
