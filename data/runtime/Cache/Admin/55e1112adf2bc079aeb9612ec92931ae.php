...
<div class="wrap js-check-wrap">
    ...
    <form class="well form-search" method="post" action="<?php echo U('payCard',['id'=>$user['id']]); ?>">
        <p style="float: right;">代理商：<img src="<?php echo ($user['user_img']); ?>" alt="<?php echo ($user['user_img']); ?>" style="height: 40px;" /><span style="margin-left: 10px;font-size: 16px;"><?php echo ($user['nickname']); ?></span></p>
        当前用户状态：
    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td style="text-align:center;">
                    <?php echo ($val['nickname']); ?> <img src="<?php echo ($val['user_img']); ?>" alt="<?php echo ($val['user_img']); ?>" style="width:40px;height: 40px;" />
                </td>
                <!--<td style="text-align:center;">
                    <?php if($val['role'] == '1'): ?><span style="font-size: 14px;color: #1dccaa;font-weight: bold;">普通用户</span>
                        ...
                        <?php else: ?>
                        <span style="font-size: 14px;color: #999999;font-weight: bold;">暂无角色</span><?php endif; ?>
                </td>-->
                <td style="text-align:center;">
                    <?php if($val['status'] ==1){?>
