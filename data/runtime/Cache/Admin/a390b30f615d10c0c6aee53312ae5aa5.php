...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <form class="well form-search" method="post" action="<?php echo U('Admin/Grade/gradelist'); ?>">
            ...
            <!--</select> &nbsp;&nbsp;-->
            关键字： 
            <input type="text" name="keyword" style="width: 200px;" value="" placeholder="请输入要查询的代理商名称...">
            <input type="button" id="selectUser" class="btn btn-primary agent-name-keyword" value="搜索">
        </form>
    ...
    <table class="table table-hover table-bordered">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td style="width:300px; height: 53px; text-align:center;">
                <button style="background: #2c3e50;border:0px; width: 70px; height: 36px;" ><a href="<?php echo U('sendCard',['id'=>$val['id']]);?>"><span style="color: white; font-size: 8px;">发卡</span></a></button>
                ...
                <button style="background: #2c3e50;border:0px; width: 100px; height: 36px;" ><a href="<?php echo U('sendCardRecord',['id'=>$val['id']]);?>"><span style="color: white; font-size: 8px;">查看发卡记录</span></a></button>
            </td>
