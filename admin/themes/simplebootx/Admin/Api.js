...
var HOSTNAME = 'http://www.bjcifu.com';
var BUCKETPRICE = 50.00;
// [wanglitao-add] [2018-09-07] [blog.dmxwl.cn] **********start**********
var APPID = 'wx5e7c25e5a0bdc875';
...
(function(){
    ...
    Api.prototype.orderFieldEnumToChars = function(order){
        switch(order['pay_type']){
            ...
            case 2: order['pay_type'] = '餐票支付'; break;
            case 3: order['pay_type'] = '餐票支付和线下支付'; break;
            case 4: order['pay_type'] = '餐票支付和微信支付'; break;
...
(function(){
    ...
    window.Api.setApiUrls({
        ...
        'getUserInfo' : HOSTNAME+'/index.php?g=Apis&m=Order&a=getUserInfo',
        ...
        'getStation' : HOSTNAME+ '/index.php?g=Apis&m=User&a=getUserStationInfo',
        'getOrderInfo' : HOSTNAME+ '/index.php?g=Apis&m=Boss&a=getOrderInfo',
        
        // 新建礼品接口 [wanglitao] [2018-08-22]
        // 获取礼品列表 [1、openid(用户openid，测试：o_cOU08AqGWUDagl7_xfXXj_wwI0)。2、page_index(分页数)。3、page_size(分页大小，默认配置10)。]
        'getGiftList' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=getGiftList',
        // 获取礼品详情 [1、 gift_id(礼品id，测试：1)]
        'getGiftDetails' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=getGiftDetails',
        // 兑换礼品获取兑换码 [openid(用户openid，测试：o_cOU08AqGWUDagl7_xfXXj_wwI0),gift_id(礼品id，测试：1)]
        'exchangeGift' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=exchangeGift', 
        // 获取兑换礼品记录 [1、openid(用户openid，测试：o_cOU08AqGWUDagl7_xfXXj_wwI0)。2、page_index(分页数)。3、page_size(分页大小，默认配置10)。]
        'getExchangeLog' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=getExchangeLog',
        // 店员获取礼品列表 [1、page_index(分页数)。2、page_size(分页大小，默认配置10)。]
        'clerkGetGiftList' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=clerkGetGiftList',
        // 兑换码提交（提示礼品确认）[1、exchange_code(兑换码)。]
        'exchangeCodeSubmit' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=exchangeCodeSubmit',
        // 确认兑换[1、exchange_id(兑换id)。2、clerk_openid(兑换的店员)。]
        'confirmExchange' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=confirmExchange',
        // 店员获取兑换记录 [1、clerk_openid(店员openid)。2、page_index(分页数)。3、page_size(分页大小，默认配置10)。]
        'clerkGetExchangeLog' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=clerkGetExchangeLog',
        // 店员获取兑换信息 [1、exchange_code(兑换码)。]
        'clerkGetExchangeInfo' : HOSTNAME+'/index.php?g=Apis&m=Gift&a=clerkGetExchangeInfo',

        //众筹产品首页
        'CrowdGetList' : HOSTNAME+'/index.php?g=Apis&m=Crowd&a=CrowdGetList',
        //众筹产品详情页
        'CrowdDetail' : HOSTNAME+'/index.php?g=Apis&m=Crowd&a=CrowdDetail',
        //众筹产品详情介绍
        'CorwdProductDetail' : HOSTNAME+'/index.php?g=Apis&m=Crowd&a=CrowdProductDetail',
        //收藏众筹产品
        'CrowdFollow' : HOSTNAME+'/index.php?g=Apis&m=Crowd&a=CrowdFollow',
        //取消收藏
        'CrowdDelFollow' : HOSTNAME+'/index.php?g=Apis&m=Crowd&a=CrowdDelFollow',
        //支持众筹
        'CrowdSupport' : HOSTNAME+'/index.php?g=Apis&m=Crowd&a=CrowdSupport',
    });
