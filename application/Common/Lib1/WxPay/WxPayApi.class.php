...
use Common\Lib\WxPay\WxPayException;
use Common\Lib\WxPay\WxPayConfig;
use Common\Lib\WxPay\WxPayData\WxPayResults;
use Common\Lib\WxPay\WxPayData\WxPayReport;
/**
 * 
...
class WxPayApi
{
    ...
    public static function unifiedOrder($config, $inputObj, $timeOut = 6)
    {
       ...
       //  echo $xml;die;
//         $xml = '<xml>
//     <appid><![CDATA[wx26e23c4ce75fe2b1]]></appid>
//     <attach><![CDATA[test]]></attach>
//     <body><![CDATA[test]]></body>
//     <mch_id><![CDATA[1512120761]]></mch_id>
//     <nonce_str><![CDATA[512hem2zs7eegcdy0wmq4ci7ifupbn27]]></nonce_str>
//     <notify_url><![CDATA[TA[http://ysq.edshui.com/payNotify.php]]><]]></notify_url>
//     <openid><![CDATA[o9lWX1L0C8tekOssYlqsPs5c8zsE]]></openid>
//     <out_trade_no><![CDATA[b2c7180831097766374591]]></out_trade_no>
//     <spbill_create_ip><![CDATA[TA[223.72.66.47]]><]]></spbill_create_ip>
//     <time_expire><![CDATA[20180831210841]]></time_expire>
//     <time_start><![CDATA[20180831205841]]></time_start>
//     <total_fee><![CDATA[1]]></total_fee>
//     <trade_type><![CDATA[JSAPI]]></trade_type>
//     <sign>B412AF8563304D53FE910260EAB528CB</sign>
// </xml>';
     ...
     * @return 成功时返回，其他抛异常
     */
    public static function orderQuery($inputObj, $timeOut = 6, $config)
    {   
     ...
     */
    public static function notify($callback, &$msg, $config, $obj1, $callback1)
    {   
        //获取通知的数据
        ...
        return call_user_func($callback, $result, $config, $obj1, $callback1);
    }
